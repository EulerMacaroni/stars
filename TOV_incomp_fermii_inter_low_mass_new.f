...
!        Rstep2=(1.E+13)/2.
        Rstep2= 8. !6.!10. !6.!7.!8.  !7.		! radius for change of EoS
!-------		
	   rmin=0.1  ! 0.001 ! minimal r
...
!	
	   ...
	   write(*,*) 'EoS is stored on a grid',EN1(1),EN1(N1),P1(1),P1(N1)


!---------------------------------------------------------------	
!--------------ToV:---------------------------------------------
        P0min= 1e-7 !P2(1) ! P2(3)   ! minimal P0 - take from EoS with interaction
		P0max=100.    ! maximal P0
!        P0max=P2(N1)
!		P0max=P2(N1) !*1E-12
        NPmax=200      ! number of steps for TOV
...
!        write(*,555) ri,Yi1
		write(10,555) ri,Yi1(2)  ! pressure
...
55      continue		! <<<<<----
		...
		IF(IEoS.eq.30 .and. ri.gt.Rstep2) then !--- EOS=30! select ONLY rmax > Rc!!!
...
!	   EnergiIncomp=0.001
	  	EnergiIncomp=0.0001 
!        EnergiIncomp=0.001!0.00001!0.000001  !0.005!0.0005!03
       end function	
