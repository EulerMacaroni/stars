...
def TOVmix(rho_01,rho_02,y):
    ...
    return R , M , r_val , m_val , [P1_val , P2_val] , [rho1_array , rho2_array], EoSP, EoSrho

# rho_array = linspace(1e-5, 1e0, 5, endpoint=False)
# rho_array = np.append(rho_array, linspace(1e0, 1e1, 5,endpoint=False))
# rho_array = np.append(rho_array, linspace(1e1, 1e2, 25))
# R_array = []
# M_array = []
# for rho in rho_array:
#     sol = TOVmix(rho,rho,10)
#     R = sol[0]
#     M = sol[1]
#     r = sol[2]
#     m = sol[3]
...
# plt.yscale('log')
plt.loglog(r,P[0])
plt.ylabel("Quark Pressure")
plt.xlabel("Radius")

fig2 = plt.figure(2)
# plt.yscale('log')
plt.loglog(r,P[1])
plt.ylabel("DM Pressure")
plt.xlabel("Radius")


fig3 = plt.figure(3)
plt.loglog(r,m,R,M,'o')
plt.ylabel("mass")
plt.xlabel("radius")
...
plt.xlabel("Radius")
plt.legend(["Quark", "DM", "Total"])
# plt.scatter(R_array, M_array)
# print(R_array)
# print(M_array)
