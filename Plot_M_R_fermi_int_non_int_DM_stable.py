...
data.append(np.genfromtxt('1outM_R_woInt_10m6_wInt_mN_y10_rc1_stable.dat'))
data.append(np.genfromtxt('1outM_R_woInt_10m6_wInt_mN_y10_rc2_stable.dat'))
data.append(np.genfromtxt('1outM_R_woInt_10m6_wInt_mN_y10_rc4_stable.dat'))
data.append(np.genfromtxt('1outM_R_woInt_10m6_wInt_mN_y10_rc6_stable.dat'))
data.append(np.genfromtxt('1outM_R_woInt_10m6_wInt_mN_y10_rc8_stable.dat'))
#data.append(np.genfromtxt('1outM_R.dat'))#_woInt_10m6_wInt_mN_y10_rc4.dat'))


fig, ax = plt.subplots()


xdat = np.linspace(0,500,1000)
...
#ax.set_xlim(0,25)
ax.set_xlim(1,60)#1E+2)#0,25)
ax.set_xscale('log')


ax.set_ylabel(r' $M^{\prime}$ ', fontsize=18, usetex=True)
ax.set_ylim(1E-3,4)#1E+1)
ax.set_yscale('log')
...
plt.savefig("M_R_fermi_int_non_int_m10m6_y10_rcVar_stable1.pdf",dpi=300,bbox_inches='tight',pad_inches=0.015,transparent=False)